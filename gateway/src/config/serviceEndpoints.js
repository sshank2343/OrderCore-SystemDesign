...
const ROUTE_TO_SERVICE_MAP = [
  { pathPrefix: '/auth', serviceName: 'auth-service' },
  { pathPrefix: '/products', serviceName: 'catalog-service' },
  { pathPrefix: '/graphql', serviceName: 'catalog-service' },
  { pathPrefix: '/orders', serviceName: 'order-service' },
];
